                            ...
                            <!-- CSRF TOKEN -->
                                ...
                                <!-- Adding / Editing -->
                                    ...
                                    <div class="form-group">
                                        <label for="categories_id">Product Categories</label>
                                        <ul style="list-style-type: none; padding-left: 0;">
                                            @foreach($allCategories as $category)
                                                <li><label><input type="checkbox" value="{{$category->id}}"
                                                                  name="category[]" style="margin-right: 5px;"
                                                            {{ $categoriesForProduct->contains($category) ? 'checked' : '' }}>{{$category->name}}</label>
                                                </li>
                                            @endforeach
                                        </ul>
